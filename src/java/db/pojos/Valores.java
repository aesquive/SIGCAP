 ...
 */
public class Valores implements java.io.Serializable,Comparable<Valores> {
    ...
    public String getSobretasa() {
        return this.getSobretasaLleno().trim();
    }
    ...
    public static String[] getColumnsMethods() {
        return new String[]{"FechaTexto", "TipoValor", "Emision", "Serie", "NumeroTitulosFormato","Status"};
    }
    ...
    public static String[] getColumnsDescriptions() {
        return new String[]{"Fecha", "Tipo Valor", "Emisora", "Serie", "Numero de Títulos","Status"};
    }
    ...
    public int compareTo(Valores o) {
        String tvEmiSer=getTVEmiSerie();
        String comp=o.getTVEmiSerie();
        return tvEmiSer.compareTo(comp);
    }

    private String getTVEmiSerie() {
        String tv=tipoValor==null ? "":tipoValor;
        String em=emision==null?"":emision;
        String ser=serie==null?"":serie;
        return tv+em+ser;
    }
}
